		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#logaligrouplogali-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligrouplogali-display": {
								"semanticObject": "logaligrouplogali",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.logali",
									"url": sap.ui.require.toUrl("logaligroup/logali")
								}
							}
						}
					}
